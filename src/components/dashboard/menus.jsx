...
//components
import CreateMenu from "../modals/menu";
...
const Menus = () => {
  ...
  return (
    <>
      {createTable && <CreateMenu close={handleCreateTable} />}
        ...
        <div className="flex flex-col bg-white border rounded border-gray w-full p-5">
          <div className="flex">
            ...
            <div className="flex h-auto mb-10 px-20">
              ...
              >
                <p
                  className={active === "Drink" ? "text-white" : "text-bright"}
                >
                  Drink
                </p>
              </div>
              ...
              >
                <p
                  className={
                    active === "Starter" ? "text-white" : "text-bright"
                  }
                >
                  Starter
                </p>
              ...
              >
                <p
                  className={
                    active === "Dessert" ? "text-white" : "text-bright"
                  }
                >
                  Dessert
                </p>
