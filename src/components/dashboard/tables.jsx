const Tables = () => {
  return (
    <div className="flex w-full flex-col mt-5">
      <div className="flex bg-white border rounded border-gray w-full p-5">
        <div className="flex flex-col w-4/5">
          ...
          <div className="grid grid-cols-2 gap-4 pr-5">
            <div className="flex w-full justify-between py-5 h-40 bg-another rounded">
              <p className="text-bright w-1/5 text-center text-lg">Table | 1</p>
      ...
      <div className="flex w-full justify-between mt-8 mb-10">
        ...
        <div className="flex flex-col w-2/6 bg-white border border-gray rounded p-5">
          <div className="flex justify-between">
            <div className="flex flex-col">
              <p className="text-lg text-black">Create new table</p>
